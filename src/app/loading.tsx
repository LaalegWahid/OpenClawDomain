    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 8, marginBottom: "2rem" }}>
          {[
            { icon: "✓", label: "runtime.boot", meta: "42ms", state: "done" },
            { icon: "✓", label: "agent.registry.load", meta: "118ms", state: "done" },
            { icon: "›", label: "workspace.hydrate", meta: "running", state: "active" },
            { icon: "·", label: "session.restore", meta: "pending", state: "pending" },
